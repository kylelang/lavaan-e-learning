...
Notes:  
* More information about storing (R) data can be found on
http://www.sthda.com/english/wiki/saving-data-into-r-data-format-rds-and-rdata  
* You may want to create a project (for this course or even per lab).  
...
```{r}
# the asymptotic p-values (for the off-diagonals)
round(res$P, 3) 
```

Sample size:
```{r}
# the matrix of number of observations used in analyzing each pair of variables
res$n 
```
...
<!-- Btw wrt the same z-values for the variance estimates: -->
<!-- This is because of the definitions: -->
<!-- z = Estimate / Std.Err -->
<!-- Std.Err of a variance estimate - let me call this variance estimate s2 - is sqrt(2*s2^2 / (N-1)) = sqrt(2 / (N-1)) * s2. Thus: -->
<!-- z_s2 = s2 / [sqrt(2 / (N-1)) * s2] = 1 / [sqrt(2 / (N-1))] = sqrt((N-1)/2). -->
<!-- Here, N = 175 and thus Std.Err of a variance estimate is sqrt((175-1)/2), for all variance estimates. -->
