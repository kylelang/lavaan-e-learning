...
~ (in regression) | is regressed on; used for the regression of observed outcome on observed predictors.
...
d. Based on the output of the models run in 1.1b, 1.2b, and 1.2c, what do you notice about the Chi-square ($\chi^2$)), degrees of freedom, $p$-values, factor loadings, and factor variance for the different methods?
