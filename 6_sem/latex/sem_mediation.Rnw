...
out4.1 <- sem(mod4.1, data = dat1, se = "boot", bootstrap = 500)
@
...
out5.2 <- 
    sem(mod5.2, data = dat1, std.lv = TRUE, se = "boot", bootstrap = 2000)
@
