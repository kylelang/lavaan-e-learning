...
Let's assume we want to use the KIMS data to estimate a three-factor CFA model of the *Observing*, *Describing*, and *Accepting* constructs.
Use the item numbers listed below to define each latent construct.
...
# acc =~ Q4 + Q8 + Q12 + Q16 + Q20 + Q24 + Q28 + Q32 + Q36
# '
...
# 
# kimsKeys <- list(
#   obs = c("Q1", "Q5", "Q9", "Q13", "Q17", "Q25", "Q29", "Q30", "Q33", "Q37", "Q39"),
#   des = c("Q2", "Q6", "Q10", "-Q14", "-Q18", "-Q22", "Q26", "Q34"),
#   act = c("Q3", "Q7", "-Q11", "Q15", "Q19", "-Q23", "-Q27", "-Q31", "-Q35", "Q38"),
#   acc = c("Q4", "Q8", "Q12", "Q16", "Q20", "Q24", "Q28", "Q32", "Q36")
# )
# 
# tmp1 <- kims |>
#   filter(sex == "male") |>
#   scoreItems(keys = kimsKeys, items = _)
# 
# tmp1 |> print(short = FALSE)
# 
# tmp2 <- kims |>
#   filter(sex == "female") |>
#   scoreItems(keys = kimsKeys, items = _)
# 
# tmp2 |> print(short = FALSE)
```
...
```{asis}
Everything looks good. The thresholds are equal across groups. All the parameter estimates seem sensible, and the model
