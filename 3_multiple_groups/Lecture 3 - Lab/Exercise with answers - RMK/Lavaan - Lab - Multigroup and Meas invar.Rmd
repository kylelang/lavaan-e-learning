...
You can call for the model fit measures in a few different ways, as outlined below. 
...
The number of observations is 571. Thus, there are 571 subjects.

Using the rules of thumb, we can conclude that the fit of the model is acceptable. Namely, RMSEA < .06, SRMR < .08, and CFI/TLI > .95. 
