...
#lavInspect(fit_MG1CFA_ci) # npar = 30 & 0 equality restrictions
```
...
#lavInspect(fit_MG1CFA_wi) # npar = 30 & 4 equality restrictions: on the 4 free factor loadings  ('lambda')
```
...
#lavInspect(fit_MG1CFA_si) # npar = 30+1=31 (now, also estimating alpha of the second group) & 9 equality restrictions: on the 4 free factor loadings ('lambda') and on the 5 intercepts ('nu')
```
...
# npar = 31 (now, also estimating alpha of the second group, see note above) & 14 equality restrictions: on the 4 free factor loadings ('lambda'), on the 5 intercepts ('nu'), and on the 5 residual variances ('theta')
```
<!-- Note on Df diff:  -->
<!-- si vs si_res: 5 because of (additionally) restricting the 5 residual variances. -->

<!-- *Note on contraints in output:*   -->
<!-- At the top of of the output, lavaan tells you with "1 == 16" that it restricts the 1st and 16th to-be-estimated parameters to be the same; and likewise for the other parameters.   -->
<!-- If you look at the output, you see that 1 (so, the 1st parameter of the to-be-estimated parameters) is the factor loading (lambda) of item b2pss2 of the group 'partners': -->
<!-- ````{verbatim} -->
<!-- $partner -->
