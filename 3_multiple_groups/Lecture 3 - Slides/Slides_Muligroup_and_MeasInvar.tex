...
\hldef{data_sapi}\hlopt{$}\hldef{Gender} \hlkwb{<-} \hlkwd{factor}\hldef{(data_sapi}\hlopt{$}\hldef{Gender,} \hlkwc{labels} \hldef{=} \hlkwd{c}\hldef{(}\hlsng{"male"}\hldef{,} \hlsng{"female"}\hldef{))}
\end{alltt}
\end{kframe}
\end{knitrout}
